      ...
      <div class="col-span-1">
        <div class="flex flex-col items-center space-y-4">
          <div class="w-full border rounded-lg overflow-hidden">
            <img src="{{ asset('/assets/img/product03.png') }}" alt="" class="object-cover w-full h-80">
          </div>          
        </div>
      </div>
        ...
        <div class="flex items-center space-x-4">
          <div>
            ...
            <div class="flex items-center border rounded-md overflow-hidden w-28">
              ...
              <input type="number" value="1" class="w-full text-center border-0 focus:ring-0 focus:outline-none">
              <button class="px-3 py-2 bg-gray-100 hover:bg-gray-200">+</button>
            </div>
          </div>

          <button class="flex items-center justify-center gap-2 px-6 py-3 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition">
      ...
      <div class="col-span-1 mt-10 lg:mt-0">
        <div>
          <ul class="flex border-b text-sm font-medium text-gray-600">
            <li class="mr-6"><a href="#tab1" class="active-tab px-3 py-2 border-b-2 border-blue-600 text-blue-600">Description</a></li>
